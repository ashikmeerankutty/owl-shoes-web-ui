            ...
            <Box>
                <Box as="ol">
                    <Box paddingRight="space60" fontSize="fontSize20" as="li">
                        ...
                        designating an eligible <span>Snowy Owl Bank</span> checking or savings account at least 10 days
                        prior to loan closing. If PayPlan enrollment is not completed 10 days prior to loan closing, or
                        if the loan is a product ineligible for PayPlan (like FHA loan products) the Diamond and Diamond
                        Honors tiers receive a 0.125% interest rate reduction benefit. For adjustable rate mortgages
                        (except PrimeFirst<sup>®</sup>), the discounts are applied to the interest rate only during the
                        initial fixed-rate period. For PrimeFirst<sup>®</sup> adjustable rate mortgages, the discount is
                        applied to the margin and cannot reduce the margin below 0%. Eligibility will be determined
                        three or more business days after the day the requirements are satisfied. Some reward benefits
                        cannot be combined with other offers. All mortgage interest rate reduction offers are subject to
                        a maximum interest rate reduction limit. For details on requirements, visit the Preferred
                        Rewards section of the <a href="#">Personal Schedule of Fees</a>
                        ...
                        account with{" "}
                        <span>
                            Snowy Owl Bank<sup>®</sup>
                        </span>{" "}
                        and maintain the balance required for one of the balance tiers in your combined qualifying{" "}
                        <span>Snowy Owl Bank</span> deposit accounts (such as checking, savings, certificate of deposit)
                        and/or your Merrill investment accounts (such as Cash Management Accounts, 529 Plans). You can
                        satisfy the combined balance requirement for enrollment with either:
                        <br />
                        <br />
                        <ul>
                        ...
                        <span>Snowy Owl Bank</span> Private Bank clients qualify to enroll in the Diamond tier, and may
                        qualify for the Diamond Honors tier based on their qualifying <span>Snowy Owl Bank</span>,
                ...
                <Box paddingX="space60" marginBottom="space100" display="flex" flexDirection="column" rowGap="space30">
                    ...
                    <Text fontSize="fontSize20" as="p">
                        Snowy Owl Bank, N.A. Member FDIC. Equal Housing Lender Equal Housing Lender
                    </Text>
                    <Text fontSize="fontSize20" as="p">
                        © 2022 Snowy Owl Bank Corporation. MAP4424393
                    </Text>
                </Box>
            </Box>
        </Box>
