...
const helps = [
    {
        ...
        description:
            "When you apply for a home loan with me, the Snowy Owl Bank Home Loan Navigator can help you track your loan status and more.",
        cta: "Learn more"
    },
    {
        image: helpEdu,
        ...
        description:
            "Get tips, tools and more from Snowy Owl Bank specialists as they chat with Buzzfeed's Hannah Williams.",
        cta: "Watch videos"
    },
    {
        image: helpMobile,
        ...
        description:
            "It's easy to manage your Snowy Owl Bank home loan account with secure access from your laptop, tablet or smartphone.",
        cta: "Found out more"
    }
];
