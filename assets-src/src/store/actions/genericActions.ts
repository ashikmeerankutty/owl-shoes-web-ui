...
export function updatePhoneCallModal(isOpen: boolean) {
    return {
        type: ACTION_UPDATE_PHONE_MODAL,
        payload: {
            isOpen
        }
    };
...
export function updateScheduleModal(isOpen: boolean) {
    return {
        type: ACTION_UPDATE_SCHEDULE_MODAL,
        payload: {
            isOpen
        }
    };
