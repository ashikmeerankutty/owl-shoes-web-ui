...
export const ACTION_UPDATE_PHONE_MODAL = "ACTION_UPDATE_PHONE_MODAL";
export const ACTION_UPDATE_SCHEDULE_MODAL = "ACTION_UPDATE_SCHEDULE_MODAL";

// Schedule reducer actions
export const ACTION_UPDATE_SCHEDULE = "ACTION_UPDATE_SCHEDULE";

// Alert reducer actions
